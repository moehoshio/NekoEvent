...
int main() {
    std::cout << "Testing Conan installation of NekoEvent..." << std::endl;
    ...
    if (callback_executed) {
        std::cout << "✓ Conan installation test passed!" << std::endl;
        return 0;
    } else {
        std::cerr << "✗ Conan installation test failed!" << std::endl;
        return 1;
    }
}
